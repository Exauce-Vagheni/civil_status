#include "mariages.h"
#include "ui_mariages.h"
#include "QMessageBox"
#include "QDialog"
mariages::mariages(QWidget *parent)
    : QMainWindow(parent)
    , ui(new Ui::mariages)
{
    ui->setupUi(this);
...
/*
void mariages::on_save_button_clicked()
{
...
void mariages::EcrireDansFichier(QString nomFichier, QString contenuTexte){
...
void mariages::on_lire_fichier_clicked()
{
    file_root="mariages/"+ui->name_fichier->text()+".txt";
...
void mariages::clear_all(){
    ui->name->clear();
    ui->postname->clear();
}


void mariages::on_print_file_clicked()
{
    texte=new QTextEdit();
    QString text;
...
void mariages::print(QPrinter *printer){
    texte->print(printer);
}
*/
